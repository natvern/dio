...
episode\giselle{You need to explain what an episode is before reaching
this point}, hereby ends. 
...
and free squares.\giselle{But not the whole grid, correct?} 
The action space is, 
\begin{equation*}
...
The rules are defined as a ProbLog~\cite{problog}\gielle{I think it
