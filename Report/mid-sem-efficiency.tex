...
a situation safe, then it has to be safe. We allow it to misjudge a situation and be conservative on safety. If that is the case, 
...
Expectations and guarantees of the safe controller.
...
We don't need to consider all the uncertainties, since we always know what to expect, and anything that goes against 
that knowledge is an uncertainty that needs to be dealt with. 
